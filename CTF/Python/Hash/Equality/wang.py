...
#This is the implmentation of the WANG Attack 
#Source: https://fortenf.org/e/crypto/2017/09/10/md4-collisions.html
#The Server to retrieve the flag wants 2 messages that coillide in md4 but non in md5 
#Thanks to this paper below there are two messagese for our case 
...
#Send these messages to the server and get the FLAG


# nc 130.192.5.212 6631 
# Find two strings that are both equal and different! I'll use _optimized algorithms_ to check.
# Enter the first string: a6af943ce36f0cf4adcb12bef7f0dc1f526dd914bd3da3cafde14467ab129e640b4c41819915cb43db752155ae4b895fc71b9b0d384d06ef3118bbc643ae6384
# Enter your second string: a6af943ce36f0c74adcb122ef7f0dc1f526dd914bd3da3cafde14467ab129e640b4c41819915cb43db752155ae4b895fc71b9a0d384d06ef3118bbc643ae6384
# Good job! CRYPTO25{4dc2e2e9-a14f-4382-8a44-f57852a626ef}

#Below the implementation of Wang Attack (Requires a lot of time, so i did not run the code)
