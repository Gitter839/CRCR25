...
// Simply I Modified The enc4.c file just adding the reading of another parameter
// that is the algo. For retrive the EVP_CIPHER *algo i just used 
// the function  EVP_get_cipherbyname(string_name_of_the_algo)
    ...
    if(algo==NULL){
        fprintf(stderr,"Error Algo Passed By Parameters\n");
        abort();
    }
