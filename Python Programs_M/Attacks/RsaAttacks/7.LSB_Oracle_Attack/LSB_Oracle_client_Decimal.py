...
# package for arbitrary precision floating point numbers (Not error in the outpuut as LAST LETTER)
import decimal
...
decimal.getcontext().prec = n.bit_length() # force the precision 
lower_bound = decimal.Decimal(0) # use different repres for more accuracy 
...
for i in range(n.bit_length()):
    ...
    if  bit[0] == 1:
        lower_bound = (upper_bound + lower_bound) / 2 # Not // 2 but we use normal divisionl, we have unlimited precision 
    else:
